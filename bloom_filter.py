...
def main():
    ...
    print("There are " + str(num_elements_in_filter) + " elements in the filter.")

    # Generating set B elements to encode
    ...
    encode_elements(set_B_elements, hashes, bloom_filter)
